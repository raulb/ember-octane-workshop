...
Now let's put our new helper to use. Open up [`app/components/chat-message.hbs`](../app/components/chat-message.hbs) and replace the hardcoded timestamp with an invocation of our new helper
